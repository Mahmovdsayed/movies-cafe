...
const Recommendations = ({ }: Iprops) => {
  ...
  const Recommendations = `https://api.themoviedb.org/3/movie/${slug}/similar?language=en-US&page=1`;
                  ...
                  <div key={reco.id}>
                    ...
                    >
                      <div className="z-20 absolute right-0 top-0 ">
                        <FavButton slug={reco.id} type="movie" className=" rounded-none rounded-bl-md" title={reco.original_title} date={reco.first_air_date} imgUrl={`${reco.backdrop_path == null
                      ...
                      <CardFooter className="absolute  bottom-0 bg-gray-200 dark:bg-[#181818]  flex-col items-start space-y-3">
                        <div className="text-start">
                          <p className="text-tiny">{reco.original_title}</p>
