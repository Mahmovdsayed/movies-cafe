                  ...
                  <div key={reco.id}>
                    ...
                    >
                      <div className="z-20 absolute right-0 top-0 ">
                        <FavButton slug={reco.id} type="movie" className=" rounded-none rounded-bl-md" title={reco.original_title} date={reco.first_air_date} imgUrl={`${reco.poster_path == null
