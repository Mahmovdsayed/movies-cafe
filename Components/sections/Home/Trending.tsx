    ...
    return <>
        {loading == true ? <LoadingScreen /> :
            <div className="mt-6 px-4 md:px-6 ">
                <div><Chip startContent={<FaFire />} variant="flat" color="danger" radius="sm" size="lg"><span className="font-bold text-tiny md:text-base">TRENDING MOVIES</span></Chip></div>
                                    ...
                                    >
                                        ...
                                        <CardFooter className="absolute  bottom-0 bg-gray-200 dark:bg-[#181818]  flex-col items-start space-y-3">
                                            <div className="text-start">
                                                <p className="text-tiny">{mov.original_title}</p>
