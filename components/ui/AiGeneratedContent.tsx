    ...
    return (
        <>
            ...
            <Modal
                ...
                placement="center"
                backdrop="blur"
                className="dark:bg-gray-900/10 backdrop-grayscale-100 backdrop-blur-xl"
                shadow="lg"
                isOpen={open}
                        ...
                        <>
                            ...
                            <ModalBody className="pb-10">
                                {loading ? (
                                    ...
                                    <div
                                        ref={textRef}
                                        className="text-base dark:text-white text-black leading-relaxed whitespace-pre-wrap"
                                    ></div>
                                )}
                            </ModalBody>
                        </>
